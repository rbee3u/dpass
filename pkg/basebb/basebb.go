...
// Transformer reuses base-conversion parameters; ratio approximates output
// length from input length.
...
// Transform treats in as big-endian digits in iBase and returns big-endian
// digits in oBase (leading zeros preserved).
