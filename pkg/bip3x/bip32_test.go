...
func TestSecp256k1DeriveSk(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			path:    []uint32{},
			hexSk:   "e8f32e723decf4051aefac8e2c93c9c5b214313817cdb01a1494b917c8436b35",
		},
		{
		...
		},
		{
			...
			path:    []uint32{},
			hexSk:   "4b03d6fc340455b363f51020ad3ecca4f0850280cf436c70c727923f6db46c3e",
		},
		{
			name:    "vector2 depth1 normal",
			hexSeed: "fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a5754514e4b484542",
			path:    []uint32{0},
			hexSk:   "abe74a98f6c7eabee0428f53798f0ab8aa1bd37873999041703c742f15ac7e1e",
		},
		{
		...
		},
		{
			...
			path:    []uint32{},
			hexSk:   "00ddb80b067e0d4993197fe10f2657a844a384589847602d56f0c629c81aae32",
		},
		{
		...
		},
		{
			...
			path:    []uint32{},
			hexSk:   "12c0d59c7aa3a10973dbd3f478b65f2516627e3fe61e00c345be9a477ad2e215",
		},
		{
		...
		},
		{
			...
			stub: func(t *testing.T) {
				...
				bip3x.StubHmacSha512(t, func([]byte, []byte) ([]byte, []byte) {
					...
					if calls == 1 {
						sk := make([]byte, 32)
						big.NewInt(1).FillBytes(sk)

						return sk, make([]byte, 32)
					}
		...
		},
		{
			...
			stub: func(t *testing.T) {
				...
				bip3x.StubHmacSha512(t, func([]byte, []byte) ([]byte, []byte) {
					...
					childSk := make([]byte, 32)
					new(big.Int).Sub(secp256k1.S256().N, big.NewInt(1)).FillBytes(childSk)

					return childSk, make([]byte, 32)
				})
			},
			requireErr: func(t *testing.T, err error) {
...
func TestEd25519DeriveSk(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			hexSeed: "000102030405060708090a0b0c0d0e0f",
			path:    []uint32{},
			hexSk:   "2b4be7f19ee27bbf30c667b642d5f4aa69fd169872f8fc3059c08ebae2eb19e7",
		},
		{
			name:    "vector1 depth1 hardened",
			hexSeed: "000102030405060708090a0b0c0d0e0f",
		...
		},
		{
			...
			hexSeed: "fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a5754514e4b484542",
			path:    []uint32{},
			hexSk:   "171cb88b1b3c1db25add599712e36245d75bc65a1a5c9e18d76f9f2b1eab4012",
		},
		{
		...
		},
		{
			...
			hexSeed: "4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df2e5a3c51c73235be",
			path:    []uint32{},
			hexSk:   "93617e77ebf8d931440dbcbfdf3f22ef1fdd1c393984e5f8f7f95b8591a9262c",
		},
		{
			name:    "vector3 depth1 hardened",
			hexSeed: "4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df2e5a3c51c73235be",
		...
		},
		{
			...
			hexSeed: "3ddd5602285899a946114506157c7997e5444528f3003f6134712147db19b678",
			path:    []uint32{},
			hexSk:   "4b36bc63a15797f4d506074f36f2f3904bc0f10179b5ab91183c167e9c2dcf0e",
		},
		{
			name:    "vector4 depth1 hardened",
			hexSeed: "3ddd5602285899a946114506157c7997e5444528f3003f6134712147db19b678",
...
func TestEd25519DeriveSkErrors(t *testing.T) {
	tests := []struct {
		name       string
		hexSeed    string
		path       []uint32
		...
		{
			name:    "non-hardened index at depth1",
			hexSeed: "000102030405060708090a0b0c0d0e0f",
			path:    []uint32{0},
			requireErr: func(t *testing.T, err error) {
