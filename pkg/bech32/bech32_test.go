...
func TestEncode(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			hrp:   "tb",
			hexVs: "00",
			hexIn: "1863143c14c5166804bd19203356da136c985678cd4d27a1b8c6329604903262",
		...
		},
		{
			...
			hrp:   "bc",
			hexVs: "01",
			hexIn: "751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6",
		...
		},
		{
			...
			hrp:   "bc",
			hexVs: "02",
			hexIn: "751e76e8199196d454941c45d1b3a323",
		...
		},
		{
			...
			hrp:   "tb",
			hexVs: "00",
			hexIn: "000000c4a5cad46221b2a187905e5266362b99d5e91c6ce24d165dab93e86433",
			out:   "tb1qqqqqp399et2xygdj5xreqhjjvcmzhxw4aywxecjdzew6hylgvsesrxh6hy",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			vs, err := hex.DecodeString(tt.hexVs)
			require.NoError(t, err)
			in, err := hex.DecodeString(tt.hexIn)
			require.NoError(t, err)
			out, err := bech32.Encode(tt.hrp, vs, in)
			require.NoError(t, err)
